...
I'll pick up right where I left off, with the rest of the Racket Essentials chapter. It's list, iteration, and... recursion time? Oops. Seems like I might have gotten ahead of myself with [the end of part one](/node/first-steps-with-racket#completing-fizz-buzz). Anyways. There are many functions which _operate_ on lists, but before we can get to any of the fun stuff, we need to create a list! That's where `list` comes in.
...
[^1]: I've been building [a multiplayer Othello web app](https://github.com/sydrinea/olly)

[^2]: Yes, there are benefits to one-based indexing in particular contexts

[^3]: My puzzle inputs are posted in [my GitHub repository for Advent of Code](https://github.com/sydrinea/advent-of-code)

[^4]: This describes [the first quarter of this one](#the-latter-half-of-racket-essentials) and most of [the last one](/node/first-steps-with-racket)
