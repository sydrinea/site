...
pubDate: "2024-05-31"
collection: "blog"
description: "How I wrote my very own compiler from scratch, and what I learned along the way."
tags: ["compilers", "reflection"]
featured: true
---

**Eight months** of hard work and dedication on the **same project**! How crazy is that? As someone who can _never_ manage to finish their projects, this was quite the accomplishment for me.
...
For the curious looking to take a peek at the code and/or run the compiler themselves, the GitHub repository is [here](https://github.com/sydrinea/kyanite).
